...
generate_stock_report = Task(
    ...
    4. Show in table format the key metrics and analysis for the stock
    5. Conclude with a summary that ties all insights back to the original question
...
st.markdown("---")
st.markdown("Made by Bhargav Sidram")
